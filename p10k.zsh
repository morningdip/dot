...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=223
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=108
  ...
  typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND=142
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%109F'  # blue foreground
      local   modified='%175F'  # purple foreground
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=245
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=175
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=109
